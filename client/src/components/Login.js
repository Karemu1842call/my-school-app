    ...
    <>
      <section class="bg-primary dark:bg-gray-900" >
          ...
          <form action="#" method="POST" class="space-y-8" onSubmit={onSubmit}>
            ...
            <div>
              ...
              <input
                ...
                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light"onSubmit={onSubmit}
        ...
        <aside>
            ...
            <button className="text-white bg-gradient-to-b from-cyan-500 to-blue-500 px-6 py-3 my-8 mx-auto flex items-center rounded-md hover:scale-110 duration-300"onSubmit={onSubmit}>
              Signup
            </button>
            </aside>
          </form>
